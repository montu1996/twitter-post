...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Save_jsx__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Edit_jsx__ = __webpack_require__(20);
...
registerBlockType('twitter-post/twitter', {
    ...
    edit: __WEBPACK_IMPORTED_MODULE_1__components_Edit_jsx__["a" /* default */],
    save: __WEBPACK_IMPORTED_MODULE_0__components_Save_jsx__["a" /* default */]
});
    ...
    _createClass(Save, [{
        ...
        value: function render(_ref) {
            ...
            if (attributes.tweets && attributes.tweets.length !== 0) {
                var tweets = attributes.tweets;
                var listTweets = tweets.map(function (tweet) {
                    return wp.element.createElement(
                        ...
                        wp.element.createElement(
                            ...
                            wp.element.createElement(
                                'p',
                                { 'class': 'quote-phrase', style: textStyle },
                                tweet.text
                            )
                        )
                    );
                });
                slider = wp.element.createElement(
                    'div',
                    { id: 'carousel' },
                    wp.element.createElement(
                        'div',
            ...
            return wp.element.createElement(
                'div',
                { style: styles, className: attributes.twitter_handle_name + "twitter-block" },
                slider
            );
        }
    }]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__InputBox_jsx__ = __webpack_require__(21);
...
var Edit = function (_Component) {
    ...
    function Edit() {
        ...
        _this.state = { isTwitterHandleClick: false };

        _this.setTwitterHandle = _this.setTwitterHandle.bind(_this);
        _this.backgroundColorChange = _this.backgroundColorChange.bind(_this);
        _this.backgroundFontColorChange = _this.backgroundFontColorChange.bind(_this);
        return _this;
    }

    _createClass(Edit, [{
        key: 'setTwitterHandle',
        value: function setTwitterHandle(newHandleName) {
            this.props.setAttributes({ twitter_handle_name: newHandleName });
            var props = this.props;
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get(twitter_posts.URL + 'tweets.php', {
                params: {
        ...
        key: 'backgroundColorChange',
        value: function backgroundColorChange(newColor) {
            this.props.setAttributes({ background_color: newColor });
        }
    }, {
        key: 'backgroundFontColorChange',
        value: function backgroundFontColorChange(newColor) {
        ...
        value: function render() {
            ...
            var InsCtrl = focus && wp.element.createElement(
                InspectorControls,
                { key: 'controls' },
                wp.element.createElement(__WEBPACK_IMPORTED_MODULE_0__InputBox_jsx__["a" /* default */], {
                ...
                wp.element.createElement(
                    'div',
                    { className: "twitter-handle-backgrounnd" },
                    wp.element.createElement(
                        'label',
                        null,
                ...
                wp.element.createElement(
                    'div',
                    { className: "twitter-handle-fontcolor" },
                    wp.element.createElement(
                        'label',
                        null,
                        "Select Font Color: "
            ...
            return [InsCtrl, wp.element.createElement(
                'div',
                { style: styles, className: attributes.twitter_handle_name + "twitter-block" },
                slider
            )];
...
var InputBox = function (_React$Component) {
    ...
    function InputBox() {
        ...
        var _this = _possibleConstructorReturn(this, (InputBox.__proto__ || Object.getPrototypeOf(InputBox)).apply(this, arguments));

        _this.state = { searchValue: _this.props.searchName };
    ...
    _createClass(InputBox, [{
        ...
        value: function render() {
            return wp.element.createElement(
                "div",
                { className: "tweeter-handle-div" },
                wp.element.createElement(
                    "div",
                    { className: "tweeter-handle-input" },
                ...
                wp.element.createElement(
                    "div",
                    { className: "tweeter-handle-button" },
                    wp.element.createElement(
                        Button,
                        {
                            isPrimary: true,
